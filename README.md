...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-selinux-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11693&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-selinux-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-selinux` can be installed with:

```
conda install python-selinux
```

It is possible to list all of the versions of `python-selinux` available on your platform with:
